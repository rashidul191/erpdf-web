                ...
                <div class="flex flex-wrap w-full">
                    ...
                    <div class="flex flex-wrap items-center w-full md:w-1/2">
                        ...
                        <x-labeled-input label="Room Image (1920x800px)" type="file"
                            ...
                            value="{{ business_setting('spe_room_img') }}" required />
                    </div>
                    <div class="flex flex-wrap items-center w-full md:w-1/2">
                        <img width="50" height="50" id="preRestaurantImg" src="{{ business_image('spe_restaurant_img') }}">
                        <x-labeled-input label="Restaurant Image (1920x800px)" type="file"
                            ...
                            value="{{ business_setting('spe_restaurant_img') }}" required />
                    </div>
                    ...
                    <div class="flex flex-wrap items-center w-full md:w-1/2">
                        ...
                        <x-labeled-input label="Luxury Image (1920x800px)" type="file"
                            ...
                            value="{{ business_setting('spe_luxury_img') }}" required />
                    </div>
                    <div class="flex flex-wrap items-center w-full md:w-1/2">
                        <img width="50" height="50" id="preMeetingHallImg" src="{{ business_image('spe_meeting_hall_img') }}">
                        <x-labeled-input label="Meeting Hall Image (1920x800px)" type="file"
                            ...
                            value="{{ business_setting('spe_meeting_hall_img') }}" required />
                    </div>

                    <x-labeled-input label="Title" name="spe_title" type="text"
                        value="{!! business_setting('spe_title') !!}" class="w-full md:w-1/2 p-1" required />

                    <x-labeled-textarea label="Short Description" name="spe_description" type="text"
                        value="{!! business_setting('spe_description') !!}" required class="w-full md:w-1/2 p-1" />
