    ...
    <form action="{{ route('admin.client-say.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white p-4">
            ...
            <div class="flex flex-wrap justify-center w-full">
                ...
                <x-labeled-input name="address" class="w-full p-1 md:w-1/2 lg:w-1/3" />
                <x-labeled-textarea label="Description" name="description" required class="w-full p-1 md:w-1/2 lg:w-1/3" />
