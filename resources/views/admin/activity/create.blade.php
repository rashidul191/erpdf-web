<x-admin-app-layout :title="__('Create Activity')">

    <div class="pb-3 flex justify-between">
        <div class="text-md md:text-2xl">{{ __('Create Activity') }}</div>
        <div>
    ...
    <form action="{{ route('admin.activity.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white p-4">
            ...
            <div class="flex flex-wrap justify-center w-full">
                ...
                <x-labeled-input type="number" name="count" required class="w-full md:w-1/2 p-1" />
