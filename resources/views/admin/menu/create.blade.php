        ...
        <form action="{{ route('admin.menu.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div x-data="{ isCustom: false }" class="flex flex-wrap justify-center w-full">
                ...
                <div class="w-full flex items-center space-x-4 p-2">
                    <input type="checkbox" id="is_custom" name="is_custom" x-model="isCustom" value="{{ \App\Enums\IsAgreeStatus::Yes }}">
                    <label for="is_custom" class="text-lg font-semibold">Is Custom</label>
                </div>

                <!-- If NOT custom -->
                <div class="w-full" x-show="!isCustom">
                    <x-labeled-select label="Select Menu Name" name="page_id" class="w-full p-1" x-bind:required="!isCustom">
                ...
                <div class="w-full flex flex-wrap" x-show="isCustom">
                    <x-labeled-input label="Menu Name" name="name" class="w-full p-1 md:w-1/2" x-bind:required="isCustom" />
