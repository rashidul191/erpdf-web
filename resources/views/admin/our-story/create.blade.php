        ...
        <div class="bg-white p-4">
            ...
            <div class="flex flex-wrap justify-center w-full">
                <x-labeled-input label="Image (800x500px)" type="file"
                    accept="image/jpeg,image/png,image/jpg,image/webp" name="image" class="w-full p-1 md:w-1/2" required
                    oninput="prevImage.src=window.URL.createObjectURL(this.files[0])" />

                <x-labeled-input label="Year Duration" name="date" class="w-full p-1 md:w-1/2"
