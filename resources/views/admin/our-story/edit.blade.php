<x-admin-app-layout :title="__('Edit Project Progress')">

    <div class="pb-3 flex justify-between">
        <div class="text-md md:text-2xl">{{ __('Edit Project Progress') }}</div>
        <div>
    ...
    <form action="{{ route('admin.our-story.update', $ourStory->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white p-4">
            ...
            <div class="flex flex-wrap justify-center w-full">
                ...
                <x-labeled-textarea label="Description" name="description" is-editor="is-editor" value="{!! $ourStory->description !!}"
                    class="w-full p-1" />
