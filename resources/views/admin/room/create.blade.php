<x-admin-app-layout :title="__('Create Room')">

    <div class="pb-3 flex justify-between">
        <div class="text-md md:text-2xl">{{ __('Create Room') }}</div>
        <div>
    ...
    <form action="{{ route('admin.room.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="w-full md:flex items-start justify-between md:space-x-4">
            <div class="w-full md:w-2/3">
                <!-- Room Name -->
                <x-labeled-input label="Room Name" name="name" required class="w-full p-1 " />
            ...
            <div class="w-full md:w-1/3">
                ...
                <div class="w-full p-1">
                    ...
                    <select name="room_category_id" id="room_category_id" class="select2 w-full rounded border-gray-300">
