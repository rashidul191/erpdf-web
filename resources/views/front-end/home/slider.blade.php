    ...
    <div id="welcome" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.1">
        <ul>
            ...
            <li data-index="rs-90{{ $i + 1 }}"
                ...
                data-description="">
                <!-- MAIN IMAGE -->
                <img src="{{ asset($item->image) }}" alt="" data-lazyload="{{ asset($item->image) }}" data-bgposition="center center"
                ...
                <div class="tp-caption tp-resizeme"
                    ...
                    style="z-index: 13; 
                            ...
                            font-weight: 900;
                            color:rgba(0,0,0,0);">
                    <span class="slider-text-outline" style="font-family: 'Roboto', sans-serif;text-transform:uppercase;">0{{ $i + 1 }}</span>
                </div>
                ...
                <div class="tp-caption tp-resizeme"
                    ...
                    <a href="{{ $item->page_link ? url($item->page_link):  'javascript:void(0);' }}" class="site-button slider-btn-left btn-half"><span> More
                    </span><em></em></a>
