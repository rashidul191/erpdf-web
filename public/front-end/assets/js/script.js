(function ($) {
    ...
    // Submenu (level 2) dropdown button
    // if ($(".main-header .submenu ul.subofsubmenu").length) {
    //     $(".main-header .submenu").append(
    //         '<div class="sub-dropdown-btn"><span class="fa fa-angle-right"></span></div>',
    //     );

    //     $(".main-header .submenu .sub-dropdown-btn").on("click", function (e) {
    //         e.stopPropagation();
    //         $(this).prev("ul.subofsubmenu").slideToggle(400);
    //     });
    // }
